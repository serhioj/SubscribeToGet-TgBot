...
async def send_welcome(message: Message):
    await message.answer(
        "Я могу показать пальцем на ошибки, которые допускают ваши конкуренты на своих сайтах, и как они теряют клиентов."
        "Расскажу, как улучшить показатели вашего сайта и получать больше заявок, совершенно бесплатно — @defmadethis"
        )

@dp.message(Command("me"))
async def send_welcome(message: Message):
    await message.answer(
        "Узнать, спросить, купить, продать, поболтать — @defmadethis"
        )
    
@dp.message(Command("blog"))
async def send_welcome(message: Message):
    await message.answer(
        "Рад, что вызвал у вас интерес 🤝 Еще больше полезных фишек вы найдёте <a href='https://t.me/defdesign'>в моем телеграм-канале</a>, "
        "где я регулярно делюсь рекомендациями, как увеличить продажи с помощью сайта 📈",
        parse_mode="HTML"
        )
